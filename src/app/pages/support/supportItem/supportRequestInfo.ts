export class SupportRequestInfo {
  ...
  static fromJson({ ADDRESS_1, ADDRESS_2, ADR_END_DATE_VALID, ADR_START_DATE_VALID, COMPANY_NAME, COUNTRY, EMAIL, FIRST_NAME, LAST_NAME, PHONE, POST_CODE, TOWN }): SupportRequestInfo {
